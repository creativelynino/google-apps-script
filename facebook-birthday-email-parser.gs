...
function theFacebookBirthdays() {
  ...
  try {
    ...
    let spread = Sheets.Spreadsheets.get("your-spreadsheet-id"); //https://docs.google.com/spreadsheets/d/{your-spreadsheet-id}/edit#gid=0
